%------------------------------------------------------------------------------
% File     : NUN025^1 : TPTP v7.2.0. Released v6.4.0.
% Domain   : Number Theory
% Problem  : Function h s.t. h(0) = 1, h(1) = 0, h(2) = 1, no witness
% Version  : Especial.
...
% Source   : [TPTP]
% Names    : ntape6-2-without-witness.tptp [Rie16]

% Status   : Theorem
% Rating   : 1.00 v6.4.0
% Syntax   : Number of formulae    :    4 (   0 unit;   3 type;   0 defn)
%            Number of atoms       :   35 (   6 equality;  15 variable)
%            Maximal formula depth :   12 (   6 average)
%            Number of connectives :   24 (   2   ~;   0   |;   4   &;  15   @)
%                                         (   0 <=>;   3  =>;   0  <=;   0 <~>)
%                                         (   0  ~|;   0  ~&)
