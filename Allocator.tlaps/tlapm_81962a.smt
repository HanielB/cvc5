...
;;          /\ VARIABLE_alloc_
;;             \in [CONSTANT_Client_ -> SUBSET CONSTANT_Resource_])
;;         /\ (/\ VARIABLE_unsat_[CONSTANT_c_] = {}
;;                /\ VARIABLE_alloc_[CONSTANT_c_] = {}
;;             /\ CONSTANT_S_ # {}
;;                /\ ?VARIABLE_unsat_#prime
;;                   = [VARIABLE_unsat_ EXCEPT ![CONSTANT_c_] = CONSTANT_S_]
...
;; Proof obligation #2
;; Generated from file "/home/rosalied/Documents/work/thesis-eval/tla_specs/tlaps_examples/Allocator.tla", line 134, characters 1-2
            ...
            (and
              (smt__TLA______TrigEq___Setdollarsign___Idvdollarsign___
                (smt__TLA______FunApp smt__VARIABLE___unsat___
                  smt__CONSTANT___c___) smt__TLA______SetEnum___0)
              (smt__TLA______TrigEq___Setdollarsign___Idvdollarsign___
