...
;;         /\ CONSTANT_S_ # {}
;;            /\ CONSTANT_S_
;;               \subseteq STATE_available_ \cap VARIABLE_unsat_[CONSTANT_clt_] ,
;;         ?VARIABLE_alloc_#prime
;;         = [VARIABLE_alloc_ EXCEPT
;;              ![CONSTANT_clt_] = VARIABLE_alloc_[CONSTANT_clt_]
;;                                 \cup CONSTANT_S_] ,
;;         ?VARIABLE_unsat_#prime
;;         = [VARIABLE_unsat_ EXCEPT
;;              ![CONSTANT_clt_] = VARIABLE_unsat_[CONSTANT_clt_] \ CONSTANT_S_] ,
;;         CONSTANT_r_
;;         \in ?VARIABLE_alloc_#prime[CONSTANT_c1_]
;;             \cap ?VARIABLE_alloc_#prime[CONSTANT_c2_] ,
;;         CONSTANT_c1_ # CONSTANT_c2_ ,
;;         ?VARIABLE_alloc_#prime[CONSTANT_c1_] = VARIABLE_alloc_[CONSTANT_c1_] ,
;;         CONSTANT_r_ \notin VARIABLE_alloc_[CONSTANT_c2_] ,
;;         CONSTANT_r_ \notin STATE_available_ ,
;;         CONSTANT_r_ \notin CONSTANT_S_ ,
;;         CONSTANT_r_ \notin ?VARIABLE_alloc_#prime[CONSTANT_c2_]
;;  PROVE  FALSE
;; TLA+ Proof Manager 1.5.0
;; Proof obligation #77
;; Generated from file "/home/rosalied/Documents/work/thesis-eval/tla_specs/tlaps_examples/Allocator.tla", line 273, characters 5-6
...
(declare-fun smt__TLA______Cup (Idv Idv) Idv)
...
(assert
  (!
    (forall ((smt__a Idv) (smt__b Idv) (smt__x Idv))
      (!
        (= (smt__TLA______Mem smt__x (smt__TLA______Cup smt__a smt__b))
          (or (smt__TLA______Mem smt__x smt__a)
            (smt__TLA______Mem smt__x smt__b)))
        :pattern ((smt__TLA______Mem smt__x (smt__TLA______Cup smt__a smt__b)))
        :pattern ((smt__TLA______Mem smt__x smt__a)
                   (smt__TLA______Cup smt__a smt__b))
        :pattern ((smt__TLA______Mem smt__x smt__b)
                   (smt__TLA______Cup smt__a smt__b)))) :named |CupDef|))
  ...
  (and
    ...
    (and
      ...
      (smt__TLA______SubsetEq smt__CONSTANT___S___
        (smt__TLA______Cap smt__STATE___available___
          (smt__TLA______FunApp smt__VARIABLE___unsat___
...
(assert
  (smt__TLA______TrigEq___Idv smt__VARIABLE___unsat______prime
    (smt__TLA______FunExcept smt__VARIABLE___unsat___ smt__CONSTANT___clt___
      (smt__TLA______SetMinus
        (smt__TLA______FunApp smt__VARIABLE___unsat___ smt__CONSTANT___clt___)
        smt__CONSTANT___S___))))
...
(assert
  (not (smt__TLA______Mem smt__CONSTANT___r___ smt__STATE___available___)))

(assert (not (smt__TLA______Mem smt__CONSTANT___r___ smt__CONSTANT___S___)))
