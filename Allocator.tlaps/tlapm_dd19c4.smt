...
;;  PROVE  (\A CONSTANT_c1_, CONSTANT_c2_ \in CONSTANT_Client_ :
...
;;         /\ (/\ VARIABLE_unsat_[CONSTANT_clt_] = {}
;;                /\ VARIABLE_alloc_[CONSTANT_clt_] = {}
;;             /\ CONSTANT_S_ # {}
;;                /\ ?VARIABLE_unsat_#prime
;;                   = [VARIABLE_unsat_ EXCEPT ![CONSTANT_clt_] = CONSTANT_S_]
...
;; Proof obligation #21
;; Generated from file "/home/rosalied/Documents/work/thesis-eval/tla_specs/tlaps_examples/Allocator.tla", line 179, characters 1-2
            ...
            (and
              (smt__TLA______TrigEq___Setdollarsign___Idvdollarsign___
                (smt__TLA______FunApp smt__VARIABLE___unsat___
                  smt__CONSTANT___clt___) smt__TLA______SetEnum___0)
              (smt__TLA______TrigEq___Setdollarsign___Idvdollarsign___
                (smt__TLA______FunApp smt__VARIABLE___alloc___
                  smt__CONSTANT___clt___) smt__TLA______SetEnum___0))
            (and
              ...
              (smt__TLA______TrigEq___Idv smt__VARIABLE___unsat______prime
                (smt__TLA______FunExcept smt__VARIABLE___unsat___
                  smt__CONSTANT___clt___ smt__CONSTANT___S___)))
