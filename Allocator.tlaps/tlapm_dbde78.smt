...
;;         /\ (/\ CONSTANT_S_ # {}
;;                /\ CONSTANT_S_
;;                   \subseteq STATE_available_ \cap VARIABLE_unsat_[CONSTANT_c_]
;;             /\ ?VARIABLE_alloc_#prime
;;                = [VARIABLE_alloc_ EXCEPT
;;                     ![CONSTANT_c_] = VARIABLE_alloc_[CONSTANT_c_]
;;                                      \cup CONSTANT_S_]
;;             /\ ?VARIABLE_unsat_#prime
;;                = [VARIABLE_unsat_ EXCEPT
;;                     ![CONSTANT_c_] = VARIABLE_unsat_[CONSTANT_c_]
;;                                      \ CONSTANT_S_])
;;         => (/\ ?VARIABLE_unsat_#prime
;;                \in [CONSTANT_Client_ -> SUBSET CONSTANT_Resource_]
;;             /\ ?VARIABLE_alloc_#prime
...
;; Proof obligation #3
;; Generated from file "/home/rosalied/Documents/work/thesis-eval/tla_specs/tlaps_examples/Allocator.tla", line 140, characters 1-2
        ...
        (and
          ...
          (and
            ...
            (smt__TLA______TrigEq___Idv smt__VARIABLE___alloc______prime
              (smt__TLA______FunExcept smt__VARIABLE___alloc___
                smt__CONSTANT___c___
                (smt__TLA______Cup
                  (smt__TLA______FunApp smt__VARIABLE___alloc___
                    smt__CONSTANT___c___) smt__CONSTANT___S___)))
            (smt__TLA______TrigEq___Idv smt__VARIABLE___unsat______prime
              (smt__TLA______FunExcept smt__VARIABLE___unsat___
                smt__CONSTANT___c___
